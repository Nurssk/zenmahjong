...
export function GameActionButton({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "flex min-h-20 min-w-[112px] flex-1 flex-col items-center justify-center gap-2 rounded-lg border border-primary/20 bg-card/85 p-3 text-center shadow-[0_10px_30px_rgba(0,0,0,0.24)] backdrop-blur-md transition-all",
